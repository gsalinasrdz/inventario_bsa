...
class Devolucion extends Model
{
    ...
    protected $fillable = [
        'folio', 'cliente_id', 'venta_id', 'almacen_id', 'usuario_id',
        'fecha_devolucion', 'estado', 'motivo', 'notas',
    ...
    public function detalles()    { return $this->hasMany(DetalleDevolucion::class); }
}
